...
export LoadConfigTBL_stopwatch_Bank1
export LoadConfigTBL_stopwatch_Bank0
export LoadConfigTBL_stopwatch_Ordered
AREA lit(rom, rel)
LoadConfigTBL_stopwatch_Bank0:
;  Instance name LCD, User Module LCD
;  Instance name SW, User Module Timer32
;       Instance name SW, Block Name TIMER32_ISB1(DBB01)
	db		27h, 00h		;SW_CONTROL_ISB1_REG(DBB01CR0)
	db		25h, 86h		;SW_PERIOD_ISB1_REG(DBB01DR1)
	db		26h, 00h		;SW_COMPARE_ISB1_REG(DBB01DR2)
;       Instance name SW, Block Name TIMER32_ISB2(DCB02)
	db		2bh, 00h		;SW_CONTROL_ISB2_REG(DCB02CR0)
	db		29h, 01h		;SW_PERIOD_ISB2_REG(DCB02DR1)
	db		2ah, 00h		;SW_COMPARE_ISB2_REG(DCB02DR2)
;       Instance name SW, Block Name TIMER32_LSB(DBB00)
	db		23h, 00h		;SW_CONTROL_LSB_REG(DBB00CR0)
	db		21h, 9fh		;SW_PERIOD_LSB_REG(DBB00DR1)
	db		22h, 00h		;SW_COMPARE_LSB_REG(DBB00DR2)
;       Instance name SW, Block Name TIMER32_MSB(DCB03)
	db		2fh, 04h		;SW_CONTROL_MSB_REG(DCB03CR0)
	db		2dh, 00h		;SW_PERIOD_MSB_REG(DCB03DR1)
	db		2eh, 00h		;SW_COMPARE_MSB_REG(DCB03DR2)
;  Instance name stateTimer, User Module Timer32
;       Instance name stateTimer, Block Name TIMER32_ISB1(DBB11)
	db		37h, 00h		;stateTimer_CONTROL_ISB1_REG(DBB11CR0)
	db		35h, c3h		;stateTimer_PERIOD_ISB1_REG(DBB11DR1)
	db		36h, 00h		;stateTimer_COMPARE_ISB1_REG(DBB11DR2)
;       Instance name stateTimer, Block Name TIMER32_ISB2(DCB12)
	db		3bh, 00h		;stateTimer_CONTROL_ISB2_REG(DCB12CR0)
	db		39h, 00h		;stateTimer_PERIOD_ISB2_REG(DCB12DR1)
	db		3ah, 00h		;stateTimer_COMPARE_ISB2_REG(DCB12DR2)
;       Instance name stateTimer, Block Name TIMER32_LSB(DBB10)
	db		33h, 00h		;stateTimer_CONTROL_LSB_REG(DBB10CR0)
	db		31h, 4fh		;stateTimer_PERIOD_LSB_REG(DBB10DR1)
	db		32h, 00h		;stateTimer_COMPARE_LSB_REG(DBB10DR2)
;       Instance name stateTimer, Block Name TIMER32_MSB(DCB13)
	db		3fh, 04h		;stateTimer_CONTROL_MSB_REG(DCB13CR0)
	db		3dh, 00h		;stateTimer_PERIOD_MSB_REG(DCB13DR1)
	db		3eh, 00h		;stateTimer_COMPARE_MSB_REG(DCB13DR2)
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_stopwatch_Bank1:
;  Instance name LCD, User Module LCD
;  Instance name SW, User Module Timer32
;       Instance name SW, Block Name TIMER32_ISB1(DBB01)
	db		24h, 00h		;SW_FUNC_ISB1_REG(DBB01FN)
	db		25h, 36h		;SW_INPUT_ISB1_REG(DBB01IN)
	db		26h, 00h		;SW_OUTPUT_ISB1_REG(DBB01OU)
;       Instance name SW, Block Name TIMER32_ISB2(DCB02)
	db		28h, 00h		;SW_FUNC_ISB2_REG(DCB02FN)
	db		29h, 36h		;SW_INPUT_ISB2_REG(DCB02IN)
	db		2ah, 00h		;SW_OUTPUT_ISB2_REG(DCB02OU)
;       Instance name SW, Block Name TIMER32_LSB(DBB00)
	db		20h, 00h		;SW_FUNC_LSB_REG(DBB00FN)
	db		21h, 16h		;SW_INPUT_LSB_REG(DBB00IN)
	db		22h, 00h		;SW_OUTPUT_LSB_REG(DBB00OU)
;       Instance name SW, Block Name TIMER32_MSB(DCB03)
	db		2ch, 20h		;SW_FUNC_MSB_REG(DCB03FN)
	db		2dh, 36h		;SW_INPUT_MSB_REG(DCB03IN)
	db		2eh, 00h		;SW_OUTPUT_MSB_REG(DCB03OU)
;  Instance name stateTimer, User Module Timer32
;       Instance name stateTimer, Block Name TIMER32_ISB1(DBB11)
	db		34h, 00h		;stateTimer_FUNC_ISB1_REG(DBB11FN)
	db		35h, 36h		;stateTimer_INPUT_ISB1_REG(DBB11IN)
	db		36h, 00h		;stateTimer_OUTPUT_ISB1_REG(DBB11OU)
;       Instance name stateTimer, Block Name TIMER32_ISB2(DCB12)
	db		38h, 00h		;stateTimer_FUNC_ISB2_REG(DCB12FN)
	db		39h, 36h		;stateTimer_INPUT_ISB2_REG(DCB12IN)
	db		3ah, 00h		;stateTimer_OUTPUT_ISB2_REG(DCB12OU)
;       Instance name stateTimer, Block Name TIMER32_LSB(DBB10)
	db		30h, 00h		;stateTimer_FUNC_LSB_REG(DBB10FN)
	db		31h, 16h		;stateTimer_INPUT_LSB_REG(DBB10IN)
	db		32h, 00h		;stateTimer_OUTPUT_LSB_REG(DBB10OU)
;       Instance name stateTimer, Block Name TIMER32_MSB(DCB13)
	db		3ch, 20h		;stateTimer_FUNC_MSB_REG(DCB13FN)
	db		3dh, 36h		;stateTimer_INPUT_MSB_REG(DCB13IN)
	db		3eh, 00h		;stateTimer_OUTPUT_MSB_REG(DCB13OU)
...
LoadConfigTBL_stopwatch_Ordered:
