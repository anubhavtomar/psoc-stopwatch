...
;  Global Symbols
;-----------------------------------------------
export  stateTimer_EnableInt
export _stateTimer_EnableInt
export  stateTimer_DisableInt
export _stateTimer_DisableInt
export  stateTimer_Start
export _stateTimer_Start
export  stateTimer_Stop
export _stateTimer_Stop
export  stateTimer_WritePeriod
export _stateTimer_WritePeriod
export  stateTimer_WriteCompareValue
export _stateTimer_WriteCompareValue
export  stateTimer_ReadCompareValue
export _stateTimer_ReadCompareValue
export  stateTimer_ReadTimer
export _stateTimer_ReadTimer
export  stateTimer_ReadTimerSaveCV
export _stateTimer_ReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  stateTimer_ReadCounter       ; obsolete
export _stateTimer_ReadCounter       ; obsolete
export  stateTimer_CaptureCounter    ; obsolete
export _stateTimer_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: stateTimer_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 stateTimer_EnableInt:
_stateTimer_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   stateTimer_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: stateTimer_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 stateTimer_DisableInt:
_stateTimer_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   stateTimer_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: stateTimer_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: stateTimer_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
_stateTimer_WritePeriod:
 stateTimer_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_2
   mov   X, SP
   mov   A, [X-6]                                ; load the period registers
   mov   reg[stateTimer_PERIOD_MSB_REG],  A
   mov   A, [X-5]
   mov   reg[stateTimer_PERIOD_ISB2_REG], A
   mov   A, [X-4]
   mov   reg[stateTimer_PERIOD_ISB1_REG], A
   mov   A, [X-3]
   mov   reg[stateTimer_PERIOD_LSB_REG],  A
...
;    functions.
;
_stateTimer_WriteCompareValue:
 stateTimer_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_2
   mov   X, SP
   mov   A, [X-6]                                ; load the compare registers
   mov   reg[stateTimer_COMPARE_MSB_REG],  A
   mov   A, [X-5]
   mov   reg[stateTimer_COMPARE_ISB2_REG], A
   mov   A, [X-4]
   mov   reg[stateTimer_COMPARE_ISB1_REG], A
   mov   A, [X-3]
   mov   reg[stateTimer_COMPARE_LSB_REG],  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: stateTimer_ReadCompareValue
;
;  DESCRIPTION:
...
;
 stateTimer_ReadCompareValue:
_stateTimer_ReadCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_3
   RAM_SETPAGE_IDX A 
   mov   A, reg[stateTimer_COMPARE_MSB_REG]
   mov   [X+0], A
   mov   A, reg[stateTimer_COMPARE_ISB2_REG]
   mov   [X+1], A
   mov   A, reg[stateTimer_COMPARE_ISB1_REG]
   mov   [X+2], A
   mov   A, reg[stateTimer_COMPARE_LSB_REG]
   mov   [X+3], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: stateTimer_ReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 stateTimer_ReadTimerSaveCV:
_stateTimer_ReadTimerSaveCV:
 stateTimer_ReadCounter:                         ; this name deprecated
_stateTimer_ReadCounter:                         ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_3
   RAM_SETPAGE_IDX A 

   ; save the Control register on the stack
   mov   A, reg[stateTimer_CONTROL_LSB_REG]
   push  A
   ...
   mov   A, reg[stateTimer_COUNTER_LSB_REG]
...
.SetupStatusFlag:
   ...
   pop   A
   mov   reg[stateTimer_CONTROL_LSB_REG], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: stateTimer_ReadTimer
;
;  DESCRIPTION:
...
;
 stateTimer_ReadTimer:
_stateTimer_ReadTimer:
 stateTimer_CaptureCounter:                      ; this name deprecated
_stateTimer_CaptureCounter:                      ; this name deprecated
