...
export LoadConfig_stopwatch
export _LoadConfig_stopwatch
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_stopwatch
	lcall	LoadConfigTBL_stopwatch_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration stopwatch
;
;    Load configuration registers for stopwatch.
...
;               CUR_PP
;
_LoadConfig_stopwatch:
 LoadConfig_stopwatch:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_stopwatch_Bank0
    mov     X, <LoadConfigTBL_stopwatch_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_stopwatch_Bank1
    mov     X, <LoadConfigTBL_stopwatch_Bank1
